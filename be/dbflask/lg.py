...
def main_chain():
    ...
    custom_prompt = PromptTemplate(
        template=(
            ...
            "Replace <PROMPT> with:\n"
            "  'Provide details of the product of the <ORDER> based on the CSV data available to you, you must address the quantity of each product by {input_text}. \n "
            ...
            "Compute <value> as the multiplication of <quantity> and the unit value from the CSV. Respond in the following format, use double quotes always for each element inside of the JSON: "
...
def main():
    ...
    user_input= "hello i want a burger"
    # Exit condition
    ...
    if interaction_context["order"]:
        order= interaction_context["order"]
        try:
    ...
    # Print the updated interaction context
